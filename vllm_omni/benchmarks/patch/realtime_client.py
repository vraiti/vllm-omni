"""Realtime WebSocket, PCM, and event helpers for driving /v1/realtime
benchmark sessions (see patch.py's async_request_openai_realtime_tts,
used for Seed-TTS multi-turn requests over one explicit session)."""
...
class RealtimeDuplexClient:
    """Small async /v1/realtime WebSocket client used by patch.py's benchmark
    request functions (e.g. async_request_openai_realtime_tts)."""
